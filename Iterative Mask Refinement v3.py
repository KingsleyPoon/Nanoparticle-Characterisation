'''
    Version 3.
        Major changes made:    
        1) Parallelisation of the NP analysis
        2) Removed multiple image analysis
    
        Minor changes made:
        2) Changed the circularity analysis to be on the ideal geometric NP, not the original NP
        3) Functions such as the objective function and feret functions have been modified to be stateless
...
class NPCharacterizationApp:
    ...
    def analyse_background_task(self):
        ...
        if not self.stop_analysis_event.is_set():
